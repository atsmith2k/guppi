...
| 🗂️ **Virtual Context Filesystem** | Exposes workspace knowledge as virtual resources (`guppi://memories/all`, `guppi://symbols/all`, `guppi://git/history`). | MCP Resources / `ReadResourceHandler` |
...
│       └── components/         # Control tabs (Overview, Memory, AST, Telemetry, Guard, Bridge, Graph, Brainstorm, SelfHeal, Mesh, TestStudio)
```
